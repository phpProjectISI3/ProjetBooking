...
type_logement# int foreign key references TYPE_LOGEMENT, -- villa/appartement/suite/chambre hotel
adress_logement varchar(100),
superficie_logement float,-- en metre carre
nbr_piece int,
capacite_personne_max int,
tarif_par_nuit_HS float, -- en dirham -- Haute saison
tarif_par_nuit_BS float, -- en dirham -- basse saison
...
logement# int foreign key references LOGEMENT,
est_disponible bit, --status du logement (en travaux/disponible) <false/true>
date_debut date, --
...
demande_reservation# int foreign key references DEMANDE_RESERVATION,
)

create table FACTURATION
(
id_facture int primary key,
reservation_logement# int foreign key references RESERVATION_LOGEMENT,
